      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 text-center text-white">
        ...
        <div className="bg-gradient-to-r from-[#415A77] to-white/70 rounded-xl shadow-lg p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-gray-800">
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="text-sm text-white-900">12124 First Street, nr 54</p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="text-sm text-white-900">hello@creative-tim.com</p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="text-sm text-white-900">+1 (424) 535-3523</p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="text-sm text-white-900">Andrew Samian</p>
          </div>
        </div>
      </div>
    </section>
